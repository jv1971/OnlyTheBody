...
public class BlurActionBarDrawerToggle extends ActionBarDrawerToggle {
	...
	/**
	 * We make a fake ImageView with width and height MATCH_PARENT. This
	 * ImageView will host the blurred snapshot/bitmap.
	 */
	private void init() {
	 ...
	 * then we blur the scaled bitmap with the preferred blur radius. Finally,
	 * we post it to our fake {@link android.widget.ImageView}.
	 */
